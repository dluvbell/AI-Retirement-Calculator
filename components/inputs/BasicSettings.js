                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '16px' }}>
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleSettingChange('spouseLockedIn.conversionAge', e.target.value)}
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleSettingChange('spouseLockedIn.unlockingPercent', e.target.value)}
                            />
                        </div>
                    </div>
                </>
