                ...
                <table style={tableStyle}>
                    <thead>
                        <tr>
                            ...
                            <th style={{...thStyle, color: '#f87171'}}>LIF W/D</th> {/* ★★★ [수정] LIF W/D 컬럼 추가 ★★★ */}
                            <th style={{...thStyle, color: '#f87171'}}>NonReg W/D</th>
                        </tr>
                    </thead>
                    <tbody>
                        {logData.map((d, index) => {
                            // ★★★ [수정] totalWithdrawal 계산에 LIF 인출액 포함 ★★★
                            const totalWithdrawal = (d.withdrawals.tfsa || 0) + (d.withdrawals.rrsp || 0) + (d.withdrawals.lif || 0) + (d.withdrawals.non_reg || 0);
                            ...
                            return (
                                <tr key={d.year} style={{ backgroundColor: index % 2 === 0 ? '#1f2937' : 'transparent' }}>
                                    ...
                                    <td style={{...tdStyle, color: '#f87171'}}>{formatCurrency(d.withdrawals.lif)}</td> {/* ★★★ [수정] LIF W/D 셀 추가 ★★★ */}
