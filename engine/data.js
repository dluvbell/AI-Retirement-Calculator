...
const createApiPayload = (scenario) => {
    ...
    const payload = {
        ...
        retirement_age: scenario.settings.startYear - scenario.settings.birthYear, // 은퇴 후 시뮬레이CATION
        ...
        // 수입/지출/이벤트
        income_items: scenario.settings.incomes,
        expense_items: scenario.settings.expenses,
